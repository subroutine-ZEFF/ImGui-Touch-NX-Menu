...
#---------------------------------------------------------------------------------
# devkitA64 GCC 15.2.0 cannot build the Dear ImGui translation units at -O2:
# it segfaults in the value-range pass on ImFontAtlasBuildWithStbTruetype, and
# again while emitting DWARF for the larger files. Both go away at -O1 with debug
# info off, which costs nothing here - the debug info is stripped from the final
# NSO regardless, and the menu is not on any hot path.
#---------------------------------------------------------------------------------
IMGUI_OFILES := imgui.o imgui_draw.o imgui_tables.o imgui_widgets.o

$(IMGUI_OFILES): CXXFLAGS := $(filter-out -g -O2 -O3,$(CXXFLAGS)) -g0 -O1
