...
entrypoint:
   // Arguments on NSO entry:
    ...
    /* The header must stay in the layout the game's rtld expects:
       `b #8` at +0x0, the MOD0 offset at +0x4, and entry code from +0x8 on.
       Minecraft's rtld reads the word at +0x8 and, when the signature string
       sat there instead of code, faulted on base + 0xD503201F (a NOP). */
    .align 4
    .ascii "~~exlaunch uwu~~"
